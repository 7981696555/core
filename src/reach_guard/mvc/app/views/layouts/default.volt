...
<html lang="en-US" class="no-js">
  <head>
    ...
    <title>{{headTitle|default("reach_guard") }} | {{system_hostname}}.{{system_domain}}</title>
    {% set theme_name = ui_theme|default('reach_guard') %}
  ...
  <main class="page-content col-sm-9 col-sm-push-3 col-lg-10 col-lg-push-2">
      ...
      <div class="row">
        ...
        <footer class="page-foot">
          <div class="container-fluid">
            <a target="_blank" href="{{ product_website }}">Reach_Guard</a> (c) {{ product_copyright_years }}
            <a target="_blank" href="{{ product_copyright_url }}">Cloud_Etel</a>
          </div>
        </footer>
      </div>
    </main>
